...
import com.nigeria.locateme.locateme.activities.ScanNiboQRActivity;
import com.nigeria.locateme.locateme.scannerUtils.wifi.WifiConfigManager;
...
public final class WifiResultHandler extends ResultHandler {
  ...
  private final ScanNiboQRActivity parent;

  public WifiResultHandler(ScanNiboQRActivity activity, ParsedResult result) {
  ...
  @Override
  public void handleButtonPress(Context context, int index) {
    if (index == 0) {
